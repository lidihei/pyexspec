...
class UiBfosc(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None, nwv=None,  wavecalibrate=True):
        ...
        self.trace_handle = []
        self.strimy = [7, 4122] #strim pixal on y axis (ystart, yend) 
        self.strimx = [30, 410] #strim pixal on x axis (xstart, xend)
    ...
    def _save_aperture(self):
        ...
        self.ap.polyfitnew(deg = 2, ystart=400, yend=3300)
        # replace old traces
    ...
    def _extract_single_star(self, fp, master_flat=None, master_flat_err_squared=None, irow=1000, show=False):
        ...
        self._adjust_aperture_star(star, ap_width = 14, Nsigma=5)
        ...
        if filename_arc is not None:
           ...
           arcdic = self._proc_lamp(fp_arc, ap_star, num_sigclip=3, verbose=False,
                                 suffix=f'_science_{os.path.basename(fp)}',
                                  wavecalibrate=False, deg=4, show=True)
    ...
    def _proc_all(self):
        ...
        self.max_master_flat = max_master_flat
        ...
        for i_star, fp in enumerate(fps_star):
            ...
            self._extract_single_star(fp, master_flat=master_flat,
                                master_flat_err_squared=master_flat_err_squared)
    ...
    def _proc_lamp(self, fp, ap_star, num_sigclip=2.5,
        ...
        lamp /= (self.master_flat/self.max_master_flat)
        ...
        if wavecalibrate:
            ...
            wave_solu = None; wave_init=None; tab_lines=None
